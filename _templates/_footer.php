...
$copy_right_content = "&copy; All rights reserved for GoInternational";
?>
<footer class="layout-dark">
  <div class="container padding-top-50px padding-bottom-35px gap-16px">
    <div class="row">
  ...
  <div class="copy-right bg-secondary">
    <div class="container padding-tb-30px">
      <div class="row">
        <div class="col-lg-6">
          <div class="copy-right-text text-lg-left text-center sm-mb-15px"><?php echo $copy_right_content ?></div>
        </div>
        <div class="col-lg-6">
          <!--  Social -->
